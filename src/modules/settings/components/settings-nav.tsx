...
import { closeSettings } from '@/shared/lib/settings-open'
  ...
  return (
    ...
    >
      <button
        ...
        className="app-no-drag text-muted-foreground hover:text-foreground mx-2 mb-2 mt-1 flex items-center gap-2 rounded-md px-2.5 py-1.5 text-left text-[13px] transition-colors outline-none"
      >
